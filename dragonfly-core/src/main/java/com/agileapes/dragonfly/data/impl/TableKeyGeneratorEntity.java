...
public class TableKeyGeneratorEntity {
    ...
    public static TableMetadata<TableKeyGeneratorEntity> getTableMetadata(String schema) {
        ...
        final ResolvedTableMetadata<TableKeyGeneratorEntity> tableMetadata = new ResolvedTableMetadata<TableKeyGeneratorEntity>(TableKeyGeneratorEntity.class, schema, "dragonfly_sequences", constraints, columns, namedQueries, Collections.<SequenceMetadata>emptyList(), Collections.<StoredProcedureMetadata>emptyList(), Collections.<ReferenceMetadata<TableKeyGeneratorEntity, ?>>emptyList());
